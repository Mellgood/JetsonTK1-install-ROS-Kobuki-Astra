...
- simulation-start.sh and simulation-clear.sh scripts wich add and remove config in bashrc and catkin_ws setup to enable ros network capabilities. You can use the scripts as shown below
From /home/ubuntu/
```shell
./simulation-clean.sh
